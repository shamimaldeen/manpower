...
@if(isset($group->id))
    @section('page_tagline', 'Update '.$group_type.'Information')
@else
    @section('page_tagline', 'Create '.$group_type.' Information')
@endif
        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                    @if(isset($group->id)) Update @else Create @endif {{ $group_type }} Information
                </h3>
            </div>
        </div>
                ...
                <div class="form-group row" style="display: none;">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" id="management_name" name="management_name"
                               value="{{ old('management_name', $group->management_name) }}" placeholder="Leader Name">
                    </div>
                </div>
                <div class="form-group row">
