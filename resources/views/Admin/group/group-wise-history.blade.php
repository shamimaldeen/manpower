...
@section('page_title', 'Group wise Customer List')
@section('page_tagline',' Group wise Customer List')
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                   <strong style="color: #3c5e79; font-size: 25px;">{{$hajis[0]->customer->group->group_name}}</strong> Customer List
                </h3>
                    @else
                    <h3 class="kt-portlet__head-title">
