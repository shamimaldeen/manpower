...
@section('page_title', $group_type . 'Information')
@section('page_tagline', $group_type . 'Agent List')
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="float-right mt-3">
                <a href="{{ route($routeNamePrefix . '.create') }}" class="btn btn-label-success btn-sm btn-upper">
                    <i class="fa fa-plus"></i> Add New {{ $group_type }}
                </a>
            </div>
        </div>
                ...
                @foreach($groups as $group)
                    <tr id="tr-{{ $group->id }}">
                        ...
                        <td class="text-center">
                            <a href="{{ route($routeNamePrefix . '.show', $group->id) }}" class="btn btn-success btn-sm btn-icon-sm btn-circle" title="View">
                            ...
                            <a href="{{ route($routeNamePrefix . '.group-history', $group->id) }}" class="btn btn-warning btn-sm btn-icon-sm btn-circle" title="Group-Wise-History">
                                History
                            </a>
