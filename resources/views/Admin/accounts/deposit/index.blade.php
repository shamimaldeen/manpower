            ...
            <table id="deposits-list-table" class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline">
                ...
                @foreach($hajis as $haji)
                    ...
                    <tr id="tr-{{ $haji->id }}">
                        ...
                        <td>{{ $haji->customer->passport->passport_no }}</td>
                        ...
                        <td class="text-center">
                            ...
                            @else
                                ...
                                <a title="Change Status" href="{{ route('deposit.change.status',$haji->id ) }}" class="btn btn-primary btn-sm btn-icon-sm btn-circle">
