...
@section('content')
    ...
    @php
        if (isset($haji->id)){
            $route = $hajj_type == 'Customer Service' ? route('package-service.update', $haji->id) : route('omra-haji.update', $haji->id);
        }else {
            $route = $hajj_type == 'Customer Service' ? route('package-service.store') : route('omra-haji.store');
            $haji = new \App\Hajj();
        }
    @endphp
    <!--begin::Form-->
                ...
                <div class="kt-portlet__foot">
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <a href="{{ $hajj_type == 'Customer Service' ? route('package-service.index') : route('omra-haji.index') }}"
