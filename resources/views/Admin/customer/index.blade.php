            ...
            <table
                ...
                @foreach($customers as $customer)
                    <tr id="tr-{{ $customer->id }}">
                        @if($customer->photo)
                        <td>
                            <img style="max-height:60px " src="{{ asset('uploads/customers/images').'/'. $customer->photo }} ">
                        </td>
                        @else
                            <td>
                                <img style="max-height:60px " src="{{ asset('uploads/customers/no_image/no_image.png')}} ">
                            </td>
                        @endif
