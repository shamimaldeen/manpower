    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="float-right mt-3">
                <a href="{{ $package_type == 'Service' ? route('package.create') : route('omra-hajj-package.create') }}" class="btn btn-label-success btn-sm btn-upper">
            ...
            <table
                ...
                @foreach($packages as $package)
                    <tr id="tr-{{ $package->id }}">
                        ...
                        <td class="text-center">
                            <a href="{{ $package_type == 'Service' ? route('package.edit', $package->id) :  route('omra-hajj-package.edit', $package->id)  }}" class="btn btn-primary btn-sm btn-icon-sm btn-circle">
