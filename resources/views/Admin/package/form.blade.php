...
@section('content')
    ...
    @php
        if (isset($package->id)){
            $route = $package_type == 'Service' ? route('package.update', $package->id) : route('omra-hajj-package.update', $package->id);
        }else {
            $route = $package_type == 'Service' ? route('package.store') : route('omra-hajj-package.store');
                ...
                <div class="kt-portlet__foot">
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <a href="{{ $package_type == 'Service' ? route('package.index') : route('omra-hajj-package.index') }}" class="btn btn-primary">Cancel</a>
