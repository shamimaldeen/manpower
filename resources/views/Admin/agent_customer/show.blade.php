    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="float-right mt-3 display-none">
                <a href="{{ route('customer.pdf', $agent->id) }}">
                                ...
                                <div class="row">
                                    <div class="col-9">
                                        <div class="row info-row">
                                            <div class="col-3 info-key font-weight-bolder">Agent Name <span
                                                        class="float-right">:</span>
                                            </div>
                                            <div class="col-9 info-value">{{ $agent->name }}</div>
                                        </div>
                                        <div class="row info-row">
                                            <div class="col-3 info-key font-weight-bolder">Contact Name <span
                                                        class="float-right">:</span>
                                            </div>
                                            <div class="col-9 info-value">{{ $agent->contact_name }}</div>
                                        </div>
                                        <div class="row info-row">
                                            <div class="col-3 info-key font-weight-bolder">Address <span
                                                        class="float-right">:</span>
                                            </div>
                                            <div class="col-9 info-value">{{ $agent->address }}</div>
                                        </div>
                                        <div class="row info-row">
                                            <div class="col-3 info-key font-weight-bolder">Mobile <span
                                                        class="float-right">:</span></div>
                                            <div class="col-9 info-value">{{ $agent->contact_no }}</div>
                                        </div>
                                        <div class="row info-row">
                                            <div class="col-3 info-key font-weight-bolder">Email
                                                <span
                                                        class="float-right">:</span></div>
                                            <div
                                                    class="col-9 info-value">{{ $agent->email }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
